...
class StudentController extends BaseController{
	...
	public function check_registration(){
		if( isset($_POST['new_student_username']) && isset($_POST['new_student_password']) && isset($_POST['new_company_name']) && isset($_POST['new_company_email']) && isset($_POST['new_student_surname']) && isset($_POST['new_company_phone']) && isset($_POST['new_student_school']) && isset($_POST['new_student_grades']) && isset($_POST['new_student_free_time']) && isset($_FILES['new_student_cv'] ) && $_FILES['new_student_cv']['error'] == UPLOAD_ERR_OK ){
