...
<form method="post" action="<?php echo __SITE_URL; ?>/index.php?rt=student/check_button_choice">
	...
	<button type="submit" name="button" value="dashboard">Dashboard</button>
		...
		<?php if ($student !== null) {
			...
			foreach($offers as $i=>$ponuda) { ?>
				...
				<tr id="red_ <?php echo $i; ?>" >
					...
					<button type="submit" id="prijava_<?php echo $i; ?>" name="button" value="application_in_offer_<?php $ponuda->id ?>"></button>
				</tr>
